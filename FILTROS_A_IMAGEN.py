# -*- coding: utf-8 -*-
"""
Created on Sun Sep 15 20:07:59 2024
...
cv2.imwrite('ladronO.jpg', isize)
cv2.imwrite('ladronGauss.jpg', RGauss)
cv2.imwrite('ladronSyP.jpg',RuidoSyP )

imagenGauss =cv2.imread('ladronGauss.jpg')
imageSyP = cv2.imread('ladronSyP.jpg')
#Filtro Gaussiano
